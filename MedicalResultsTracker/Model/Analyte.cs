...
namespace MedicalResultsTracker.Model
{
    ...
    public class Analyte
    {
        ...
        /// <summary>
        /// Встроенную запись правили руками. Обновление набора её пропускает: у каждой
        /// лаборатории свои границы, и человек вписал сюда те, что напечатаны в его бланке, —
        /// новая версия приложения не должна молча вернуть их к типовым.
        /// </summary>
